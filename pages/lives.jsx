...
async function getAllLivesQuery(cursor = "", page = 1, cb) {
    let results = await ihaAPIQuery(VideoQuerySchemas, cursor);
    let gqlres = results.data.vtuber;
    page++;
    let expectedTotal = Math.ceil(gqlres.live._total / gqlres.live.pageInfo.results_per_page);
...
class Homepage extends React.Component {
    ...
    componentDidMount() {
        ...
        getAllLivesQuery("", 1, setLoadData).then((res) => {
