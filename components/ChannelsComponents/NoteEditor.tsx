...
const mapDispatch = {
    updateNote: (payload: UpdateDataPerSteps) => ({ type: "channels/updateChannelDataById", payload }),
};
...
class NoteEditorModal extends React.Component<NoteEditorProps, NoteEditorStateReal> {
    ...
    async handleSubmission() {
        ...
        if (currentPlatform !== "unknown") {
            this.props.updateNote({
                updatedData: { extraNote: currentNote },
                targetId: currentId,
                targetPlatform: currentPlatform,
            });
        }

        this.setState({ submit: false, currentNote });
        this.doModal("hide");
    }
...
export default connector(NoteEditorModal);
